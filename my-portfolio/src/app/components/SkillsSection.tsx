      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-theme-secondary max-w-3xl mx-auto">
            Eine Übersicht über meine technischen Fähigkeiten und Erfahrungen.
            Von Frontend bis DevOps – hier sind die Tools, mit denen ich
            arbeite.
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-theme-secondary">Jahre</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-theme-primary">
                      {skill.projectsCount}
                    </div>
                    <div className="text-xs text-theme-secondary">Projekte</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xs text-theme-secondary">Zuletzt</div>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-theme-secondary font-medium">Projekte</div>
            </div>
            <div>
              <div className="text-3xl font-black bg-gradient-to-r from-blue-500 to-orange-500 bg-clip-text text-transparent mb-2">
                {Math.round(
